...
class TaskTest {
    ...
    void checkTestsEqualsIfIdsAreEquals() {
        ...
        Task task2 = new Task(1, "Bbb", "Bbb", Status.IN_PROGRESS, LocalDateTime.now(), Duration.ofMinutes(10));
    ...
    void checkTestsNotEqualsIfIdsNotEquals() {
        Task task1 = new Task(123, "Aaa", "Aaa", Status.NEW, LocalDateTime.now(), Duration.ofMinutes(10));
        Task task2 = new Task(321, "Aaa", "Aaa", Status.NEW, LocalDateTime.now(), Duration.ofMinutes(10));
